<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Admin/Admin2.Master" AutoEventWireup="true" CodeBehind="Laboratorian.aspx.cs" Inherits="EHospitalMS.Views.Admin.Laboratorian" EnableEventValidation="false" %>
  ...
  <asp:Button ID="DeleteBtn" runat="server" Text="Delete" class="btn btn-danger" OnClick="DeleteBtn_Click" /> 
            ...
            <div class="row">
                <div class="col">
                    ...
                    <asp:GridView ID="LaboratorianGV" class="table table-hover" runat="server" AutoGenerateSelectButton="True" OnSelectedIndexChanged="DoctorsGV_SelectedIndexChanged" CellPadding="4" ForeColor="#333333" GridLines="None">
